...
export { default as fixWindowsSlashes } from './fix-windows-slashes'
...
export { default as inlineString } from './inline-string'
...
export { default as timeRequire } from './time-require'
...
export { default as sizeOf } from './size-of'
